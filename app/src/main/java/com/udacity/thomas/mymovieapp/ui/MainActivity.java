...
import com.udacity.thomas.mymovieapp.adapter.MoviesAdapter;
import com.udacity.thomas.mymovieapp.databinding.ActivityMainBinding;
import com.udacity.thomas.mymovieapp.models.Movie;
import com.udacity.thomas.mymovieapp.utils.ConnectionUtils;
...
public class MainActivity extends AppCompatActivity implements MoviesAdapter.MovieOnClickListener {
    ...
    private void retrieveMovies(int state) {
        if (state == 0) {
            ...
            Call<Movie> movieCall = movieAPI.getPopularMovie( API.getAPIKey());
            ...
            Call<Movie> movieCall = movieAPI.getTopRatedMovie( API.getAPIKey());
